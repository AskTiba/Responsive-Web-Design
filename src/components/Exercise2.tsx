...
const Exercise2 = () => {
  return (
    <>
      <main className="w-[620px] mx-auto">
        ...
        <section className="bg-[#145858] text-white">
          ...
          <p className="">
            ...
            qui maiores quisquam explicabo nesciunt harum laudantium aperiam
            sapiente error, quas, temporibus sit modi, ad dignissimos.
          </p>
          <p className="">
            Lorem{" "}
            <a href="" className="">
            ...
            sit amet consectetur adipisicing elit. Sapiente, doloribus. Tempora
            ratione sed fugit modi molestias veritatis consectetur assumenda,
            quibusdam nulla ad iure maxime alias.
          </p>
